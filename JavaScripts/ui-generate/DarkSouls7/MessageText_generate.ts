 ...
 * AUTHOR: 橘色半夏
 * UI: UI/DarkSouls7/MessageText.ui
 * TIME: 2023.01.06-17.54.09
 */

 

 @UI.UICallOnly('UI/DarkSouls7/MessageText.ui')
 export default class MessageText_Generate extends UI.UIBehavior {
	...
	protected initButtons() {
		...
		this.initLanguage(this.uiWidgetBase.findChildByPath("MWCanvas_2147482460/MWTextBlock_2") as any);
